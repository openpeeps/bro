...
type
  Message* = enum
    ...
    duplicateObjectKey = "Duplicate object field $ [duplicateObjectKey]"
    duplicateCaseLabel = "Duplicate case label [caseDuplicateLabel]"
    undeclaredField = "Undeclared field $ [fieldUndeclared]"
    missingAssignmentToken = "Missing assignment token [missingAssignmentToken]"
    missingRB = "Missing closing bracket [missingRB]"
    missingRC = "Missing closing curly bracket [missingRC]"

    invalidCallContext = "Invalid call in this context"
    # Use/Imports
    importDuplicateModule = "Module $ already in use [importDuplicateModule]"
    importModuleNotFound = "Module $ not found [importModuleNotFound]"
    importCircular = "Circular import not allowed [importCircular]"
    # Condition - Case statements
    caseInvalidValue = "Invalid case statement [caseInvalidValue]"
    caseInvalidValueType = "Invalid case statement. Got $, expected $ [caseInvalidValueType]"
    colorsInvalidInput = "Invalid color [colorInvalidInput]"
    # Loops
    forInvalidIteration = "Invalid iteration [loopInvalidIteration]"
    ...
    fnUndeclared = "Undeclared function $ [fnUndeclared]"
    fnExtraArg = "Function $ expects $ arguments, $ given [fnExtraArg]"
    fnReturnVoid = "Invalid return type for $ | Got void [fnReturnVoid]"
    fnReturnTypeMismatch = "Invalid return type | Got $ expected $ [fnReturnTypeMismatch]"
    fnInvalidReturn = "Invalid return type"
    fnRedefineIdent = "Attempt to redefine parameter $ [fnRedefineIdent]"
    fnOverload = "Attempt to redefine function $ [fnOverload]"
